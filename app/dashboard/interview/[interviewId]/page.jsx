      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 ">
        ...
        <div>
          {webCamEnabled ? (
            ...
            <div>
              <WebcamIcon className="h-72 w-full my-6 p-20 bg-slate-200 bg-secondary rounded-lg border" />
            </div>
          )}
          <div className="flex flex-row justify-center items-center gap-5">
            ...
            <div className="flex justify-center my-4 md:my-0 md:justify-end md:items-end">
              <Link href={"/dashboard/interview/" + params.interviewId + "/start"}>
                <Button className="bg-green-500 hover:bg-green-700">Start Interview</Button>
              </Link>
            </div>
          </div>
        </div>
